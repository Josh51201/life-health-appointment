...
import Style from '../css/DoctorFilter.module.css';
    ...
    return (
        <div className={Style.filterBox}>
            ...
            <div className={Style.buttonPosition}>
                <h3 className={Style.centerText}>Filter by Specialty<br/>----------------------</h3>
                ...
                <button type="button" className={`${Style.buttonText} ${show4 ? Style.btnActive : Style.btnNon}`} id="paed" onClick={handleClick}>Pediatrician</button>
